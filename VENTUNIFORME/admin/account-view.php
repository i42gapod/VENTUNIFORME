<p class="lead">
    Sección para el tratamiento de las cuentas de usuarios.
</p>
<div class="container">
	<div class="row">
        <div class="col-xs-12">
                ...
                <form action="./process/updateAdmin.php" method="POST" role="form" class="FormCatElec" data-form="update">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                            	<p class="text-primary text-center" style="padding-top: 20px;">No es necesario actualizar la contraseña, sin embargo si desea hacerlo debe de introducir una nueva contraseña y repetirla.</p>
                            </div>
