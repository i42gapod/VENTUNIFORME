    ...
    <section id="container-pedido">
        <div class="container">
            <div class="page-header">
              <h1>CESTA <small class="tittles-pages-logo">AMPA Padre Cosme</small></h1>
            </div>
            <br><br><br>
            <div class="row">
                <div class="col-xs-12">
                    <?php
                        ...
                        if(!empty($_SESSION['carro'])){
                            ...
                            <a href="process/vaciarcarrito.php" class="btn btn-success btn-raised btn-lg">Vaciar la cesta</a>
                            <a href="pedido.php" class="btn btn-danger btn-raised btn-lg">Confirmar pedido</a>
                            </p>
                            ';
                        }else{
                            echo '<p class="text-center text-danger lead">SU CESTA ESTÁ VACÍA</p><br>
