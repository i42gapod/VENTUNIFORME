...
<nav id="navbar-auto-hidden">
        <div class="row hidden-xs">
            <div class="col-xs-4">
                <p class="text-navbar tittles-pages-logo"><img src="./assets/img/logo.jpg"></p>
                <p class="text-navbar tittles-pages-logo">Colegio Espíritu Santo</p>
            </div>
            <div class="col-xs-8">
                ...
                <div class="contenedor-tr">
                  ...
                  <?php
                      if(!$_SESSION['nombreAdmin']==""){
                          echo ' 
                              <a href="carrito.php" class="table-cell-td">Cesta</a>
    ...
    <div id="mobile-menu-list" class="hidden-sm hidden-md hidden-lg">
        ...
        <ul class="list-unstyled text-center">
            ...
            <li><a href="carrito.php">Cesta</a></li>
            <?php 
                if(!$_SESSION['nombreAdmin']==""){
