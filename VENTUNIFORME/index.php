    ...
    <section id="slider-store" class="carousel slide" data-ride="carousel" style="padding: 0;">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="./assets/img/slider1c.jpg" alt="slider1">
                <div class="carousel-caption">
                    
                </div>
            </div>
            <div class="item">
                <img src="./assets/img/slider2c.png" alt="slider2">
                <div class="carousel-caption">
                    
                </div>
            </div>
            <div class="item">
                <img src="./assets/img/slider3c.jpg" alt="slider3">
                <div class="carousel-caption">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                     <div class="thumbnail">
                       ...
                       <div class="caption">
                            ...
                            <h5><p><?php echo $fila['NombreProd']; ?></p></h5>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 text-center">
                   <article style="margin-top:5%;">
                        ...
                        <h3>Registrate</h3>
                        <p>Registrate como cliente de <span class="tittles-pages-logo">AMPA Padre Cosme</span> en un sencillo formulario para poder completar tus pedidos</p>
                        <p><a href="registration.php" class="btn btn-info btn-raised btn-block">Registrarse</a></p>   
                   </article>
                </div>

                <div class="col-xs-12 col-sm-6">
                    <img src="assets/img/logo_1.jpg" alt="Smart-TV" class="img-responsive" style="width: 70%; display: block; margin: 0 auto;">
                </div>
            </div>
        </div>
    </section>
