    ...
    <section id="container-pedido">
        <div class="container">
            <div class="page-header">
              <h1>PEDIDOS <small class="tittles-pages-logo">AMPA Padre Cosme</small></h1>
            </div>
            <br><br><br>
            <div class="row">
                      ...
                      <div class="container-fluid">
                        <div class="row">
                          <div class="col-xs-10 col-xs-offset-1">
                            <p class="text-center lead">El pago se efectuará a la entrega del pedido</p>
                            <img class="img-responsive center-all-contens" src="assets/img/entrega.jpg">
                             <p class="text-center">
                              <button class="btn btn-lg btn-raised btn-success btn-block" data-toggle="modal" data-target="#PagoModalTran">Continuar con la confirmación</button>
                            </p>
                          </div>
                        </div>
                      </div>
      ...
      <div class="modal-dialog" role="document">
        <form class="modal-content FormCatElec" action="process/confirmcompra.php" method="POST" role="form" data-form="save">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">Identificación de pedido</h4>
          </div>
          <div class="modal-body">
            ...
            ?>
                ...
                <div class="form-group">
                    <label>Identificador pedido</label>
                    <input class="form-control" type="text" name="NumDepo" placeholder="Numero de depoto" maxlength="50" required="">
                </div>
                <div class="form-group">
