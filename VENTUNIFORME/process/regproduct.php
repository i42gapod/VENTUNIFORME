<?php
    ...
    if($codeProd!="" && $nameProd!="" && $cateProd!="" && $priceProd!="" && $modelProd!="" && $marcaProd!="" && $stockProd!="" && $codePProd!=""){
        ...
        if($verificaltotal<=0){
            ...
            echo '<script>swal("ERROR", "El código de producto que acaba de introducir ya está registrado en el sistema, por favor introduzca otro código de producto distinto", "error");</script>';
        }
    }else {
