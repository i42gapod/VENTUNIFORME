...
if(mysqli_num_rows($verificar)<=0){
    ...
    echo '<script>swal("ERROR", "El número de CIF que ha introduido ya se encuentra registrado en el sistema, por favor introduzca otro número de CIF", "error");</script>';
}
