                ...
                <div class="row">
                  ...
                  <div class="col-xs-12 col-sm-6">
                    <div class="form-group label-floating">
                      ...
                      <input class="form-control" type="text" required name="clien-fullname" value="'.$DataUser['NombreCompleto'].'" title="Introduzca su nombre (solamente letras)" pattern="[a-zA-Z ]{1,50}" maxlength="50">
                    </div>
                  </div>
                  <div class="col-xs-12 col-sm-6">
                    <div class="form-group label-floating">
                      <label class="control-label"><i class="fa fa-user"></i>&nbsp; Apellidos</label>
                      <input class="form-control" type="text" required name="clien-lastname" value="'.$DataUser['Apellido'].'" title="Introduzca sus apellido (solamente letras)" pattern="[a-zA-Z ]{1,50}" maxlength="50">
                    </div>
                  </div>
                  <div class="col-xs-12 col-sm-6">
                    <div class="form-group label-floating">
                      <label class="control-label"><i class="fa fa-mobile"></i>&nbsp; Teléfono</label>
                        <input class="form-control" type="tel" required name="clien-phone" value="'.$DataUser['Telefono'].'" maxlength="15" title="Introduzca su número telefónico. Mínimo 8 digitos máximo 15">
                    </div>
                  </div>
                  <div class="col-xs-12 col-sm-6">
                    <div class="form-group label-floating">
                      <label class="control-label"><i class="fa fa-envelope-o" aria-hidden="true"></i>&nbsp; Email</label>
                        <input class="form-control" type="email" required name="clien-email" value="'.$DataUser['Email'].'" title="Introduzca la dirección de su Email" maxlength="50">
                    </div>
                  </div>
                  <div class="col-xs-12">
                    <div class="form-group label-floating">
                      <label class="control-label"><i class="fa fa-home"></i>&nbsp; Dirección</label>
                      <input class="form-control" type="text" required name="clien-dir" value="'.$DataUser['Direccion'].'" title="Introduzca la direción en la reside actualmente" maxlength="100">
                    </div>
                  </div>
                  <div class="col-xs-12">
                  ...
                  <div class="col-xs-12">
                    <div class="form-group label-floating">
                      <label class="control-label"><i class="fa fa-user-circle-o" aria-hidden="true"></i>&nbsp; Nombre de usuario</label>
                        <input class="form-control" type="text" required name="clien-name" value="'.$DataUser['Nombre'].'" title="Introduzca su nombre. Máximo 9 caracteres (solamente letras y numeros sin espacios)" pattern="[a-zA-Z0-9]{1,9}" maxlength="9">
                    </div>
                  </div>
